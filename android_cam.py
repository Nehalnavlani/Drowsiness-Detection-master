...
url = "http://192.168.10.7:8080///shot.jpg"
	...
	for (i, rect) in enumerate(rects): 
		...
		if EAR < EAR_THRESHOLD: 
			...
			if FRAME_COUNT >= CONSECUTIVE_FRAMES: 
				...
				emailsender.sendMail("bbsale33@gmail.com","nehal21@","nehalnavlani@gmail.com",str("dataset_phonecam/frame_sleep%d.jpg" % count_sleep),
		...
		if MAR > MAR_THRESHOLD:
			...
			emailsender.sendMail("bbsale33@gmail.com","nehal21@","nehalnavlani@gmail.com",str("dataset_phonecam/frame_yawn%d.jpg" % count_yawn),

...
def d_dtcn():
	...
	Label(root, text="DDS - Drowsiness Detection System By Group NO. 9",font=("times new roman",20),fg="black",bg="aqua",height=2).grid(row=2,rowspan=2,columnspan=5,sticky=N+E+W+S,padx=5,pady=10)
	Label(root, text="Please select your camera device",font=("times new roman",20),fg="white",bg="red",height=2).grid(row=4,columnspan=5,sticky=N+E+W+S,padx=5,pady=10)
